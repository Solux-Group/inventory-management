...
const DataKategori = () => {
  ...
  const columns = [
    { label: "No", field: "_id" },
    { label: "Nom de catégorie", field: "nama_kategori" },
  ...
  return (
    <>
      <Helmet>
        <title>Données de catégorie | INVENTORY</title>
      </Helmet>
      {showLoading ? (
          ...
          <form onSubmit={handleSubmitAddKategori}>
            <div className="flex flex-col justify-center space-y-4">
              <div className="flex flex-col space-y-2">
                <div className="">
                  Nom de catégorie <span className="text-red-400">*</span>
                </div>
                <input
                  type="text"
        ...
        <Card className="font-montserrat">
          ...
          <form onSubmit={handleSubmitEditKategori}>
            <div className="flex flex-col justify-center text-sm space-y-4">
              <div className="flex flex-col space-y-2">
                <div className="">
                  ID de catégorie <span className="text-red-400">*</span>
                </div>
                <input
                  type="text"
                  className="border border-gray-300 rounded-md focus:ring focus:ring-indigo-200 focus:outline-none p-2"
      ...
      <Card className="font-montserrat">
        <div className="font-bold text-gray-500 text-xl mb-6">
          Données sur la catégorie d'articles
        </div>
        <button
