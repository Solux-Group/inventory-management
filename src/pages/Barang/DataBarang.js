...
const DataBarang = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Inventaire | INVENTORY</title>
      </Helmet>
      {showLoading ? (
      ...
      <Modal
        ...
        <Card className="font-montserrat">
          ...
          <div className="text-sm">
            Voulez-vous vraiment supprimer des éléments ?{" "}
      ...
      <Card className="font-montserrat">
        <div className="font-bold text-gray-500 text-xl mb-6">Inventaire</div>
        <button
