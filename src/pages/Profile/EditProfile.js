...
const EditProfile = () => {
  ...
  const handleChangeFile = (e) => {
    ...
    if (file.size / 1000000 > 2) {
      setFormDataError((state) => ({
        ...state,
        foto: "Ukuran file tidak boleh lebih sur 2MB",
      }));
      e.target.value = null;
      setSelectedFile(null);
  ...
  return (
    <>
      <Helmet>
        <title>Modification du Profile | INVENTORY</title>
      </Helmet>
      {showLoading ? (
        ...
        <Card className="font-montserrat col-span-full md:col-span-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="grid grid-cols-12 items-center gap-x-4 gap-y-1">
                <div className="col-span-full md:col-span-4">
                  Nom de l'utilisateur <span className="text-red-400">*</span>
                </div>
                <input
                  type="text"
                  className="col-span-full md:col-span-8 border border-gray-300 rounded-md focus:ring focus:ring-indigo-200 focus:outline-none p-2"
                ...
                <div
                  ...
                  {`Nom de l'utilisateur ${formDataError.nama}`}
                </div>
              </div>
              <div className="grid grid-cols-12 items-center gap-x-4 gap-y-1">
                <div className="col-span-full md:col-span-4">
