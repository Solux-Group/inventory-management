...
const DataSupplier = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Données fournisseur | INVENTORY</title>
      </Helmet>
      {showLoading ? (
      ...
      <Modal
        ...
        <Card className="font-montserrat">
          ...
          <div className="text-sm">
            Êtes-vous sûr de vouloir supprimer un fournisseur{" "}
